...
//Getallsong.playingsong[Getallsong.audioplayer.currentIndex!].id;
          ...
          (onPressed: null,
           ...
           IconButton(onPressed: ()async{
            ...
            addrecentlyplayed(Getallsong.playingsong[
              Getallsong.audioplayer.currentIndex!].id);
          ...
          ElevatedButton(
            ...
            IconButton(
              iconSize: 30,
              onPressed: ()async{
                Provider.of<RecentlyProvider>(context).addrecentlyplayed(Getallsong.playingsong[Getallsong.audioplayer.currentIndex!].id
