...
import 'package:musicapp/widgets/nowplaying/playing.dart';
...
class _NowPlayingState extends State<NowPlaying> {
  ...
  void initState() {
    ...
    Getallsong.audioplayer.currentIndexStream.listen(
      (index) {
        if (index != null) {
  ...
  void playSong() {
    ...
    Getallsong.audioplayer.durationStream.listen(
      (d) {
        setState(
          () {
            _duration = d!;
    ...
    Getallsong.audioplayer.positionStream.listen(
      (p) {
        setState(
          () {
            _position = p;
  ...
  void changeToSeconds(int seconds) {
    ...
    Getallsong.audioplayer.seek(duration);
  }
